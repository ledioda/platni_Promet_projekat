...
public class ClientController {
	...
	public ClientEntity addAddressToAClient(@PathVariable Integer id, @RequestParam Integer address) {
	...
	public ClientEntity addBankToAClient(@PathVariable Integer id, @RequestParam Integer bank) {
		ClientEntity client = clientRepository.findOne(id);
		BankEntity bnk = bankRepository.findOne(bank);
		client.setBank(bnk);
		clientRepository.save(client);
		return client;
	}*/
