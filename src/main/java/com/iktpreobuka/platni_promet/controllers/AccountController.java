...
public class AccountController {
	...
	public ResponseEntity<?> addNewAccount(@RequestParam Long accountNumber, @RequestParam Double balance, @RequestParam Integer clientId ) {
	...
	public AccountEntity addClientToAAccount(@PathVariable Integer id, @RequestParam Integer client) {
	AccountEntity account = accountRepository.findOne(id);
	ClientEntity clt = clientRepository.findOne(client);
